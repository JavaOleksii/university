    ...
    <div class="w3-sidebar" style="width: 10%">
        <div class="list-group" style="margin-top: 40px">
            ...
            <c:if test="${pageContext.request.userPrincipal.name != null}">
                ...
                <a class="list-group-item" onclick="document.forms['logoutForm'].submit()"
    ...
    <div style="margin-left: 10%">
        <div class="w3-container">
            <table class="table table-striped"
                   style="margin-top: 2%; padding: 2%; width:800px; height: 150px; margin-left:30%">
                <thead>
                <tr>
                    <th>Id</th>
                    <th><spring:message code='rating.name'/></th>
                    <th><spring:message code='rating.numberOfSeats'/></th>
                    <th><spring:message code='rating.image'/></th>
                    <th><spring:message code='rating.action'/></th>
                </tr>
                </thead>
                <tbody>
                <c:forEach var="rating" items="${ratingItems}">
                    <tr style="height: 10%">
                        ...
                        <td><img src="data:image/jpg;base64,${rating.faculty.encodedImage}" alt="image" style="width: 40%; height: 20%"></td>
                        <td><a href="rating?id= ${rating.id}"><spring:message code='rating.delete'/></a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
